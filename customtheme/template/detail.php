            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="<?php bloginfo('template_directory')?>/img/header.jpg" alt="Image">
                    ...
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="<?php echo get_template_directory_uri();?>/detail.php">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="mb-5">
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="<?php bloginfo('template_directory')?>/img/courses-80x80.jpg" alt="">
                            <div class="pl-3">
